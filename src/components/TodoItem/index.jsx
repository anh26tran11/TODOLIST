...
const TodoItem = ({ listItem, setShowDialog, handleDelete, handleStatus }) => {
  return (
    <div className="space-y-4">
      {listItem.map((item) => (
        <div
          key={item.id}
          className={`relative ${
            item.isCompleted ? "bg-green-300" : "bg-orange-300"
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p
                className={`text-sm font-bold ${
                  item.isCompleted ? "text-green-700" : "text-orange-500"
                } mt-1`}
              >
            ...
            <button
              ...
              className="cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive text-primary-foreground shadow-xs has-[>svg]:px-3 w-auto h-auto border-3 rounded-lg border-black [box-shadow:2px_2px_0px_#000!important] bg-transparent absolute right-20 top-1/2 transform -translate-y-1/2 px-3 py-1 ml-4"
              type="button"
